...
INSERT INTO PEOPLE(ID, CARD, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('0', '2', 'Administrator', NULL, '0', TRUE, NULL);
-- INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('1', 'Manager', NULL, '1', TRUE, NULL);
INSERT INTO PEOPLE(ID, CARD, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('2', '1', 'Kassierer', NULL, '2', TRUE, NULL);
...
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('000', 'MWSt reduziert 7%');
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('001', 'MWSt 19%');
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('002', 'keine MWSt 0%');
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER)
 VALUES ('000', 'MWSt reduziert 7%', '000', NULL, NULL, 0.07, FALSE, NULL);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) 
VALUES ('001', 'MWSt 19%', '001', NULL, NULL, 0.19, FALSE, NULL);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) 
VALUES ('002', 'keine MWSt 0%', '002', NULL, NULL, 0.0, FALSE, NULL);
...
CREATE TABLE TICKETSNUM_NOSALE (
    ID INTEGER not null AUTO_INCREMENT,
PRIMARY KEY(ID)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO TICKETSNUM_NOSALE VALUES (0);
